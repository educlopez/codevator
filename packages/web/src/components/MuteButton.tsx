...
export function MuteButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-6 right-6 z-50 w-10 h-10 rounded-full bg-lumon-dark/80 border border-white/10 flex items-center justify-center backdrop-blur-sm transition-all hover:border-lumon-mint/40 hover:bg-lumon-dark cursor-pointer"
    ...
    >
      {muted ? (
        ...
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-lumon-mint/70">
          <path d="M11 5L6 9H2v6h4l5 4V5z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
