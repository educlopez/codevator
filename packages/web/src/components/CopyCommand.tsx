...
export function CopyCommand({ command }: { command: string }) {
  ...
  return (
    <button
      ...
      className="group flex items-center gap-3 rounded-full bg-white/80 border border-olive-950/15 px-6 py-3.5 hover:border-olive-950/25 transition-colors cursor-pointer"
    >
